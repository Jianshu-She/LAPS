#!/bin/bash
# Full benchmark: all 5 settings × extended concurrency (1..512) × 3 runs
#
# Settings:
#   1. Vanilla SGLang
...
#
# Usage: bash bench_72b_full_extended.sh
set -euo pipefail
...
BASE_RESULTS_DIR="${SCRIPT_DIR}/results_72b_full_extended"

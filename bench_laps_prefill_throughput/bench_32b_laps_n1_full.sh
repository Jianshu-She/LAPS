#!/bin/bash
# Full benchmark: Qwen2.5-32B, TP=1, all 5 settings × extended concurrency × 3 runs
...
#
# Usage: bash bench_32b_laps_n1_full.sh
set -euo pipefail
...
BASE_RESULTS_DIR="${SCRIPT_DIR}/results_32b_laps_n1_full"
...
title = f'Qwen2.5-32B, TP=1 (1x H200) — AGGREGATE ({num_runs} runs)'
lines = []
lines.append('')
lines.append('=' * 170)

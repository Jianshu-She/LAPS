#!/bin/bash
# Rerun LAPS setting only for 32B NO-flush benchmark (results_32b_tp4).
# Restarts servers for each cc level to avoid CUDA illegal memory access.
set -euo pipefail
...
RESULTS_DIR="${SCRIPT_DIR}/results_32b_tp4"

...
#   5. LAPS (anti-starvation N=4, with batch prefill CUDA graph)
#
# Usage: bash bench_32b_full_extended.sh
set -euo pipefail
...
BASE_RESULTS_DIR="${SCRIPT_DIR}/results_32b_full_extended"

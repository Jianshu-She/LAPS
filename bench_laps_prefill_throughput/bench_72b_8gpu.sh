#!/bin/bash
# Benchmark prefill throughput on Qwen2.5-72B-Instruct with 8 GPUs (TP=4) and concurrency sweep.
#
# 3 settings x 7 concurrency levels = 21 data points.
# Prefill server: GPU 0,1,2,3 (TP=4); Decode server: GPU 4,5,6,7 (TP=4).
#
# Usage: bash bench_72b_8gpu.sh
set -euo pipefail
...
RESULTS_DIR="${SCRIPT_DIR}/results_72b_8gpu"
